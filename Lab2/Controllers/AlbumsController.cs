...
namespace Lab2.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public AlbumsController(LyricsServiceContext context)
        {
            _context = context;
        }
        ...
        {
            var lyricsServiceContext = _context.Albums.Include(a => a.Artist);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ArtistId")] Album album)
        {
            if (id != album.Id)
            {
                return NotFound();
